...
==============================================================================*/
module understanding.graph.template {
 ...
 *   Object with min level of the template and an Array of understanding.graph.Group]
 *   sort by ascending order of minimum depth at which metanode appears.
 */
function clusterSimilarSubgraphs(h: hierarchy.Hierarchy) {
  /** a dict from metanode.signature() => Array of understanding.graph.Groups */
...
function isSimilarSubgraph(g1: graphlib.Graph<any, any>,
  ...
  if (!understanding.graph.hasSimilarDegreeSequence(g1, g2)) {
      return false;
  }
