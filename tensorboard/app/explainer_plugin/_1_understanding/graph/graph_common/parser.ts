...
==============================================================================*/
module understanding.graph.parser {
...
export function fetchAndParseMetadata(path: string, tracker: ProgressTracker) {
  return understanding.graph.util
      ...
      .then((arrayBuffer: ArrayBuffer) => {
        return understanding.graph.util.runAsyncPromiseTask(
...
export function fetchAndParseGraphData(path: string, pbTxtFile: Blob,
  ...
  return understanding.graph.util
      .runTask(
          ...
          tracker)
      .then((arrayBuffer: ArrayBuffer) => {
        return understanding.graph.util.runTask('Parsing graph.pbtxt', 60, () => {
...
export function parseGraphPbTxt(input: ArrayBuffer):
    Promise<understanding.graph.proto.GraphDef> {
...
export function parseStatsPbTxt(input: ArrayBuffer):
    Promise<understanding.graph.proto.StepStats> {
...
} // Close module understanding.graph.parser.
