...
==============================================================================*/
module understanding.graph.scene {
 ...
 *   <g class='core'>
 *     <g class='edges'>
 *       ... stuff from understanding.graph.scene.edges.build ...
 *     </g>
 *     <g class='nodes'>
 *       ... stuff from understanding.graph.scene.nodes.build ...
 *     </g>
 *   </g>
 *   <g class='in-extract'>
 *     <g class='nodes'>
 ...
 * @param sceneElement <tf-understanding-graph-scene> polymer element.
...
export function addHealthPill(
  ...
  if (nodeInfo != null && nodeInfo.node.type === understanding.graph.NodeType.OP) {
