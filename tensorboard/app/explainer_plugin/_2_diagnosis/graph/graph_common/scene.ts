 ...
 *   <g class='core'>
 *     <g class='edges'>
 *       ... stuff from diagnosis.graph.scene.edges.build ...
 *     </g>
 *     <g class='nodes'>
 *       ... stuff from diagnosis.graph.scene.nodes.build ...
 *     </g>
 *   </g>
 *   <g class='in-extract'>
 *     <g class='nodes'>
 ...
 * @param sceneElement <tf-diagnosis-graph-scene> polymer element.
...
export function addHealthPill(
  ...
  if (nodeInfo != null && nodeInfo.node.type === diagnosis.graph.NodeType.OP) {
