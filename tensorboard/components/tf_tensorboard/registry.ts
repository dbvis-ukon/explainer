...
export interface Dashboard {
  ...
  /**
   * Allows multiple dashboards for a single backend plugin. This makes sense
   * if multiple dashboards use the same backend routes. If this parameter is
   * omitted, the default plugin property is used.
   */
